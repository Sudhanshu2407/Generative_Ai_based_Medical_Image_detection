...
#         default_prompt = "write a complete caption for this image in the well organized manner"
...
from gemini_utility import (load_gemini_pro_model,
                                    ...
                                    gemini_pro_vision_response,
                                    embeddings_model_response,
                                    medical_image_analysis_response)
...
with st.sidebar:
    selected = option_menu('Gemini AI',
                           ...
                           menu_icon='robot', icons=['chat-dots-fill', 'image-fill', 'textarea-t', 'patch-question-fill', 'heart-pulse'],
                           default_index=0
                           )
...
# Medical Image Detection Page
elif selected == "Medical Image Detection":
    ...
    if uploaded_image and st.button("Analyze Image"):
        ...
        result = medical_image_analysis_response(image)
